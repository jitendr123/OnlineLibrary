...
<nav class="navbar navbar-expand-sm navbar sticky-top">
  ...
  <div class="container">
  <h1 class="class_title">SE BOOKS</h1>
     <div class="row">
         <table>
             <thed>
                <th>FILE NAME</th>
             ...
             <tbody>
               <?php foreach($files as $file): ?>
                <tr align=center>
                  ...
                  <td>
                    <a href="admin/uploads/<?php echo $file['name']?>" target="_blank" rel="noopener noreferrer" style="color:white" class="open">Open</a>
                   </td>
               </tr>
                  <?php endforeach;?>
             </tbody>  
