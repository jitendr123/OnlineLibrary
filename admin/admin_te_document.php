...
<?php
  include "admin_te_fileslogic.php";
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
  ...
  <div class="container">
  <h1 class="class_title">TE BOOKS </h1>
    <div class="upload">  
      <form action="admin_te_document.php" method="post" enctype="multipart/form-data"><br><br>
             ...
             <tbody>
               <?php foreach($files as $file): ?>
                <tr align=center>
                  ...
                  <td>
                    <a href="./beuploads/<?php echo $file['name']?>" target="_blank" rel="noopener noreferrer" style="color:white" class="open">Open</a>
                   </td>
               </tr>
                  <?php endforeach;?>
             </tbody>  
