...
<div class="login">
        <h1 style="text-align: center; font-size:35px;font-family: Lucida Console;">Online Library System</h1>
     ...
     if(isset($_POST['submit']))
     {
       ...
       if($count==0)
       {
         ?>
          ...
          <div class="alert alert-warning" style=" width :700px ; margin-left:400px;text-align:center;background-color:#de1313;color:white;  position: relative ; bottom:550px;">
